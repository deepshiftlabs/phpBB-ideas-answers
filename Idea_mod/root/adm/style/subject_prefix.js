...
$(document).ready(function() {
    ...
    $('#prefix_bgcolour').change(function() {
        // Make sure the preview is displayed
        if ($('#prefixBgColourPreview').css('display') == 'none')
        {
            $('#prefixBgColourPreview').css('display', 'inline');
        }

        $('#prefixBgColourPreview').css('background-color', '#' + $(this).val());
    });
